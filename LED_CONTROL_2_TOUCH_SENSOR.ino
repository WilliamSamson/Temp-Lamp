...
void hot () {
  ...
  pixels.setPixelColor(46, pixels.Color(50, 50, 50));
  ...
  pixels.setPixelColor(60, pixels.Color(50, 0, 50));
...
void loop() {
  int touchState = digitalRead(sensorpin);
...
// WAVE MODE
  ...
  Serial.println("The sensor is not being touched");
    waveR () ;
  delay(500);
  pixels.clear();
  delay(500);
